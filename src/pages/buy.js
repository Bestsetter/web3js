...
const VendingMachine = () =>{
    ...
    const [lotterystatus,setLotterystatus] = useState('none')
    const [owneraddress,setOwneraddress] = useState('none')
    const [totalevent,setTotalevent] = useState('none')
    const [totalamount,setTotalamount] = useState('none')
    const [tokenaddress,setTokenaddress] = useState('none')
    const [exchangeaddress,setExchangeaddress] = useState('none')
    const [eventidstart,setEventidstart] = useState('eventid')
    const [eventtdcomplete,setEventtdcomplete] = useState('eventid')
    const [eventidcancel,setEventidcancel] = useState('eventid')
    const [eventdetail,setEventdetail] = useState('eventid')
    const [eventfee,setEventfee] = useState('eventid')
    const [eventpriceperticket,setEventpriceperticket] = useState('eventid')
    const [eventstartEnd,setEventstartEnd] = useState(['eventid'])
    const [eventidname,setEventidname] = useState('eventid')
    const [getbonus,setgGetbonus] = useState('eventid')
    const [eventIdtokenIdlength,setEventIdtokenIdlength] = useState('eventid')

    const [eventIdwinprediction,setEventIdwinprediction] = useState('eventid')
    const [eventIdwintokenId,setEventIdwintokenId] = useState('eventid,list')
    const [getTokenIdtakenmoney,setGetTokenIdtakenmoney] = useState('ticketid')
    const [getEnentIdwinner,setGetEnentIdwinner] = useState('eventid')
    const [getEnentIdwinprediction,setGetEnentIdwinprediction] = useState('eventid')
    ...
    const getTokenId_win = () => {
		...
		console.log(callfunction)
        callfunction.then((a) => { setGetTokenIdwin(String(a)) })
    }
    const getEventId_wintokenId = () => {
        const callfunction = contract_lottery_winner.methods.getEventId_wintokenId(eventid,list).call();
		console.log(callfunction)
        callfunction.then((a) => { setGetEventIdwintokenId(a) })
    }
    ...
    const eventId_wintokenId = () => {
        const callfunction = contract_lottery_winner.methods.eventId_wintokenId(eventid,list).call();
		console.log(callfunction)
        callfunction.then((a) => { setEventIdwintokenId(a) })
    }
    const enentId_winprediction = () => {
        const callfunction = contract_lottery_winner.methods.enentId_winprediction(eventid).call();
		console.log(callfunction)
        callfunction.then((a) => { setEventIdwinprediction(a) })
    }
            ...
            <Head>
                ...
                <div className='container'>
                    ...
                    <div>
                        ...
                        <span>{eventIdtokenIdlength}</span>
                    </div>
                    {/* ======================================================= */}
